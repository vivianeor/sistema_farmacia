...
<center><form method="post" action="alterar_saida_back.php">

<br> Codigo Saida: <select size="1" name="codsaida">
<?php
// gera lista de saida// fazer a conexão
...
Codigo Loja: <select size="1" name="codloja">
<?php
