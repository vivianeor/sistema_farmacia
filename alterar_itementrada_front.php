...
<center><form method="post" action="alterar_itementrada_back.php">

<br> Codigo Item Entrada: <select size="1" name="coditementrada">
<?php
// gera lista de itementrada // fazer a conexão
