...
<center><form method="post" action="alterar_produto_back.php">

<br> Codigo Produto: <select size="1" name="codproduto">
<?php
...
Codigo Categoria: <select size="1" name="codcategoria">
<?php
...
Codigo Fornecedor: <select size="1" name="codfornecedor">
<?php
