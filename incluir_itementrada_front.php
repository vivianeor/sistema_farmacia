...
<center> 
<form method="post" action="incluir_itementrada_back.php"><br>
<p>

Codigo Item Entrada:
<input type="text" name="coditementrada" ><br>
<br>
...
Codigo Entrada:<select size="1" name="entrada_codentrada">

<?php
// Gera a lista de entradas
$conexao=mysql_connect("localhost","root","vertrigo");
mysql_select_db("sistema_farmacia_matutino",$conexao);
